...
namespace PingCastle.Healthcheck.Rules
{
    ...
    [RuleSTIG("V-243493", "Active Directory data must be backed up daily for systems with a Risk Management Framework categorization for Availability of moderate or high. Systems with a categorization of low must be backed up weekly.")]
    [RuleMaturityLevel(3)]
