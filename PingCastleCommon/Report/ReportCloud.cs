...
");
        ...
        {
            GenerateSection("Entra ID Indicators", () =>
            {
...
<h5 class='card-title'>");
    ...
    <p class='card-text'>");
        ...
        private void GenerateExternalTenantsInformation()
        {
            ...
            if (Report.CrossTenantPolicies != null)
            {
                ...
                AddParagraph("This information is extracted from https://learn.microsoft.com/en-us/azure/active-directory/external-identities/cross-tenant-access-settings-b2b-direct-connect");
            ...
            if (Report.ForeignDomains != null)
            {
                ...
                Add(JsonSerializer.Serialize(Report.ForeignDomains));
                Add(@"</script>");
            }
        }
        ...
        {
            AddParagraph("This section gives information about the user accounts stored in Entra ID");
            ...
            AddHeaderText("Nb User Internal Members Pure Entra");
            AddHeaderText("Password never expires");
            AddBeginTableData();
            AddBeginRow();
  ...
  <div class=""card-body pie-chart"">
    <h5 class=""card-title"">Guest users <br>");
            ...
            Add(@"<div class=""card"">
  <div class=""card-body pie-chart"">
    <h5 class=""card-title"">External members <br>");
            ...
            Add(@"<div class=""card"">
  <div class=""card-body pie-chart"">
    <h5 class=""card-title"">Pure Entra members<br>");
        ...
        private void GenerateApplicationInformation()
        {
            ...
            AddHeaderText("Entra Role", "The number of Entra native roles");
            AddBeginTableData();
