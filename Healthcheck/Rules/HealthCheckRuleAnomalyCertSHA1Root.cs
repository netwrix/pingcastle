...
{
	[RuleModel("A-SHA1RootCert", RiskRuleCategory.Anomalies, RiskModelCategory.CertificateTakeOver)]
    ...
    public class HealthCheckRuleAnomalyCertSHA1Root : RuleBase<HealthCheckData>
    {
