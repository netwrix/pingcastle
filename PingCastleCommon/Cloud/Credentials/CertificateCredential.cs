...
namespace PingCastle.Cloud.Credentials
{
    public class CertificateCredential : IDisposable, IAzureCredential
    {
        ...
        private CertificateCredential(ITokenFactory tokenFactory)
        {
            _tokenFactory = tokenFactory;
        }

        public static CertificateCredential LoadFromCertificate(string clientId, string tenantId, X509Certificate2 certificate, ITokenFactory tokenFactory)
        {
            if (!certificate.HasPrivateKey)
                throw new ApplicationException("Certificate without private key");

            var cred = new CertificateCredential(tokenFactory);
        ...
        public static CertificateCredential LoadFromKeyFile(string clientId, string tenantId, string key, string thumbPrint, ITokenFactory tokenFactory)
        {
        ...
        public static CertificateCredential LoadFromP12(string clientId, string tenantId, string p12file, string password, ITokenFactory tokenFactory)
        {
        ...
        {
            return await _tokenFactory.GetToken<T>(this);
        }
