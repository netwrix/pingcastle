...
namespace PingCastle.ADWS
{
    public class LinuxFileConnection : IFileConnection
    {
        ...
        /// <summary>
        /// No implementation, just runs the Func<typeparamref name="T"/>
        /// </summary>
        public T RunImpersonatedIfNeeded<T>(Func<T> func) => func();

        /// <summary>
        /// No implementation, just runs the Action/>
        /// </summary>
        public void RunImpersonatedIfNeeded(Action action) => action();
