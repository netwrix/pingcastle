...
using PingCastleCommon.Properties;
using System;
...
");
    ...
    protected void Brand(ADHealthCheckingLicense license)
    {
        if (!license.IsBasic())
        {
            try
            {
                var options = ServiceProviderAccessor.Current.GetService<Microsoft.Extensions.Options.IOptions<BrandOptions>>();

                var brandSettings = options.Value;
                if (brandSettings != null)
                {
                    if (!string.IsNullOrEmpty(brandSettings.BrandLogo))
                        brandLogo = brandSettings.BrandLogo;
                    if (!string.IsNullOrEmpty(brandSettings.BrandCss))
                        AddStyle(brandSettings.BrandCss);
                    if (!string.IsNullOrEmpty(brandSettings.BrandJs))
                        AddScript(brandSettings.BrandJs);
                }
            }
            catch (Exception)
            {
                // Blind exception handling - brand is non-critical.
            }
        }
    }
...
<li><a href=""https://bootstrap-table.com/"">Bootstrap Table Export</a> licensed under the <a href=""https://tldrlegal.com/license/mit-license"">MIT license</a></li>
<li><a href=""https://github.com/hhurz/tableExport.jquery.plugin/"">Table Export</a> licensed under the <a href=""https://tldrlegal.com/license/mit-license"">MIT license</a></li>
		...
		<div class=""col-lg-12"">
			<div class=""starter-template"">
				<div class=""mb-4 mt-4 lead fs-6"">
					<div class=""h3 fw-bold section-header-container"">
...
");
    ...
    // ref: https://learn.microsoft.com/en-us/archive/technet-wiki/22615.how-to-get-the-number-of-computers-per-windows-operating-system-in-an-active-directory-domain-using-powershell
    ...
    protected string GetLinkForLsaSetting(string property)
    {
        switch (property.ToLowerInvariant())
        {
            case "enableguestaccount":
                return @"<a href=""https://learn.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/accounts-guest-account-status"">Guest account</a> (<a href=""https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-gpsb/d6eaa54a-f609-48e9-8461-b32738d77a47"">Technical details</a>)";
            case "lsaanonymousnamelookup":
                return @"<a href=""https://learn.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/network-access-allow-anonymous-sidname-translation"">Allow anonymous SID/Name translation</a> (<a href=""https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-gpsb/d6eaa54a-f609-48e9-8461-b32738d77a47"">Technical details</a>)";
            case "everyoneincludesanonymous":
                return @"<a href=""https://learn.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/network-access-let-everyone-permissions-apply-to-anonymous-users"">Let Everyone permissions apply to anonymous users</a>";
            case "limitblankpassworduse":
                return @"<a href=""https://learn.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/accounts-limit-local-account-use-of-blank-passwords-to-console-logon-only"">Limit local account use of blank passwords to console logon only</a> (<a href=""https://learn.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/jj852174(v=ws.11)"">Technical details</a>)";
            case "forceguest":
                return @"<a href=""https://learn.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/network-access-sharing-and-security-model-for-local-accounts"">Sharing and security model for local accounts</a> (<a href=""https://learn.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/jj852219(v=ws.11)"">Technical details</a>)";
            case "lmcompatibilitylevel":
                return @"<a href=""https://learn.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/network-security-lan-manager-authentication-level"">LAN Manager authentication level</a> (<a href=""https://learn.microsoft.com/en-us/previous-versions/windows/it-pro/windows-2000-server/cc960646(v=technet.10)"">Technical details</a>)";
            case "nolmhash":
                return @"<a href=""https://learn.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/network-security-do-not-store-lan-manager-hash-value-on-next-password-change"">Do not store LAN Manager hash value on next password change</a> (<a href=""https://learn.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2003/cc736342(v=ws.10)"">Technical details</a>)";
            case "restrictanonymous":
                return @"<a href=""https://learn.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/network-access-do-not-allow-anonymous-enumeration-of-sam-accounts-and-shares"">Do not allow anonymous enumeration of SAM accounts and shares</a> (<a href=""https://learn.microsoft.com/en-us/previous-versions/windows/it-pro/windows-2000-server/cc963223(v=technet.10)"">Technical details</a>)";
            case "restrictanonymoussam":
                return @"<a href=""https://learn.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/network-access-do-not-allow-anonymous-enumeration-of-sam-accounts"">Do not allow anonymous enumeration of SAM accounts</a> (<a href=""https://learn.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/jj852184(v=ws.11)"">Technical details</a>)";
            case "ldapclientintegrity":
                return @"<a href=""https://learn.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/network-security-ldap-client-signing-requirements"">LDAP client signing requirements</a> (<a href=""https://learn.microsoft.com/en-us/troubleshoot/windows-server/active-directory/enable-ldap-signing-in-windows-server"">Technical details</a>)";
            case "recoveryconsole_securitylevel":
                return @"<a href=""https://learn.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/recovery-console-allow-automatic-administrative-logon"">Recovery console: Allow automatic administrative logon</a>";
            case "refusepasswordchange":
                return @"<a href=""https://learn.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/domain-controller-refuse-machine-account-password-changes"">Refuse machine account password changes</a> (<a href=""https://learn.microsoft.com/en-us/troubleshoot/windows-server/windows-security/disable-machine-account-password"">Technical details</a>)";
            ...
            case "enablescriptblocklogging":
                return @"<a href=""https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_group_policy_settings?view=powershell-6"">Powershell: Turn on Powershell Script Block logging</a>";
            ...
            case "supportedencryptiontypes":
                return @"<a href=""https://learn.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/network-security-configure-encryption-types-allowed-for-kerberos"">Network security: Configure encryption types allowed for Kerberos</a>";
    ...
    {
        // coefficient to fix rendering of invalid input parameters (mostly to keep reports with old bugged data renderable)
        // it shouldn't have any effect on valid data
        double scalar = Math.Max(1, (double)vals.Sum() / total);
        var width = radius * 2;
        ...
        {
            var val = vals[i];
            var degrees = (int)(((double)val / scalar / total) * 360);
            int from = previousto;
            int to = degrees + from;
            previousto = to;

            string tooltip = null;
            if (tooltips != null && i < tooltips.Count + 1)
            {
                tooltip = tooltips[i];
            }

            AddPath(radius, from, to, null, tooltip: tooltip, fill: GetColor(i, vals.Count));
            t += val;
        }
        if (t < total)
            AddPath(radius, previousto, previousto + ((double)(total - t) / total) * 360, "empty");
        if (total == 0)
            AddPath(radius, 0, 360, "empty");
