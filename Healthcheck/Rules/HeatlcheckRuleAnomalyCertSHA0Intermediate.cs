...
{
	[HeatlcheckRuleModel("A-SHA0IntermediateCert", HealthcheckRiskRuleCategory.Anomalies, HealthcheckRiskModelCategory.CertificateTakeOver)]
	[HeatlcheckRuleComputation(RuleComputationType.TriggerOnPresence, 5)]
    public class HeatlcheckRuleAnomalyCertSHA0Intermediate : HeatlcheckRuleBase
    {
