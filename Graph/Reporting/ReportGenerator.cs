...
namespace PingCastle.Graph.Reporting
{
    public class ReportGenerator
    {
        ...
        private void RetrieveDirectNodesAndLinks(int rootNodeId,
                                                 Dictionary<int, Node> knownNodeAfterThis,
                                                 Dictionary<int, List<int>> tree,
                                                 List<int> directUserNodes,
                                                 List<int> directComputersNodes,
        ...
        private void BuildTree(int rootNodeId,
                               Dictionary<int, Node> knownNodeAfterThis,
                               List<int> directUserNodes,
                               List<int> directComputersNodes,
                               Dictionary<int, List<Relation>> links)
